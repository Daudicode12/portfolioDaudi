        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <div key={index} className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105">
      ...
      <section id="contact" className="py-20 px-4 bg-black/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a href="mailto:davidonya2@gmail.com" className="bg-gray-800/50 backdrop-blur-lg p-6 rounded-2xl border border-gray-700 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105">
              <Mail className="w-8 h-8 text-cyan-400 mx-auto mb-4" />
              <div className="font-semibold">Email</div>
              <div className="text-sm text-gray-400">davidonya2@gmail.com</div>
            </a>
            
            <a href="https://linkedin.com/in/daudislugger" target="_blank" rel="noopener noreferrer" className="bg-gray-800/50 backdrop-blur-lg p-6 rounded-2xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300 hover:scale-105">
              <Linkedin className="w-8 h-8 text-blue-400 mx-auto mb-4" />
              <div className="font-semibold">LinkedIn</div>
              <div className="text-sm text-gray-400">Connect with me</div>
            </a>
            
            <a href="https://github.com/Daudicode12" target="_blank" rel="noopener noreferrer" className="bg-gray-800/50 backdrop-blur-lg p-6 rounded-2xl border border-gray-700 hover:border-purple-500/50 transition-all duration-300 hover:scale-105">
